...
from create_data import createTimeSeries_D, remove_parts_of_graph_encoder
...
def plot_encoder_interpolation_CE():
    ...
    y_values_spline, y_noise_spline,min_value_spline, max_value_spline, noise_std = createTimeSeries_D(x_values, y_start, config['random_number_range'], config["spline_value"], config["vocab_size"])
