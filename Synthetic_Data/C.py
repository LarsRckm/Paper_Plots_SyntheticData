...
from create_data import createTimeSeries_C, remove_parts_of_graph_encoder
from plot import predict_encoder_interpolation_projection_roundedInput, plot_multiple_pred_with_names_error_bar_interpolationPainting
...
def plot_encoder_interpolation_CE():
    ...
    y_values_spline, y_noise_spline,min_value_spline, max_value_spline, noise_std = createTimeSeries_C(x_values, y_start, config['random_number_range'], config["spline_value"], config["vocab_size"])
