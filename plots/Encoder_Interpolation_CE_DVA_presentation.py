...
import sys
sys.path.append(".")
from plot import plot_multiple_pred_with_names, denoise_floaterCurrent_encoder_interpolation_CE, plot_multiple_pred_with_names_error_bar_single_presentation, plot_multiple_pred_with_names_error_bar_single_presentation_02
import pandas as pd
import numpy as np
import os
import math
...
if __name__ == "__main__":
    ...
    for file in files:
        ...
        result.append([[data, "Noisy Data", "blue"],
        ...
        plot_multiple_pred_with_names_error_bar_single_presentation_02(x_values, result, titles, labels)