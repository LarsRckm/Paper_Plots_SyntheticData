import sys
sys.path.append(".")
from plot import plot_multiple_pred_with_names, denoise_floaterCurrent_encoder_interpolation_CE,plot_multiple_pred_with_names_error_bar_single_presentation
import pandas as pd
import numpy as np
import torch
import os
...
def plot_floater_current_CE():
    ...
    result.append([
        ...
        [y_masked, "Noisy Data (Masked)", "blue"]
    ...
    plot_multiple_pred_with_names_error_bar_single_presentation(x_values, result, titles, labels)
