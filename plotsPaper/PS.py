...
from plot import predict_encoder_interpolation_projection_roundedInput, plot_multiple_pred_with_names_error_bar
...
def plot_encoder_interpolation_CE():
    ...
    model_filename = "weights/Encoder_Interpolation_CE_PeriodicSum_300.pt"
